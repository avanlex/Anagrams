...
public class MainPresenter implements MainContract.Presenter {
    ...
    //Обрати внимание на аргументы конструктора - мы передаем экземпляр View, а Model просто создаём конструктором.
    ...
    public void onDestroy() {
         ...
         *
         * "If we were working with RxJava, for example, it would be worth unsubscribing from subscriptions in this class
         * Besides, when working with other asynchronous Android methods, here we struggle with context leakage"
         */
        Log.d(TAG, "onDestroy()");
    }
}